...
var _default2 = createComponent({
  ...
  methods: {
    ...
    onStepperState: function onStepperState(data) {
      if (data.valid) {
        ...
        this.stepperError = (0, _extends4.default)({}, data, {
          action: 'plus'
        });
      }
    },
  ...
  render: function render() {
    ...
    }, [this.stockText])]), this.hasSku && !this.hideSelectedText && h(_SkuHeaderItem.default, [this.selectedText]), slots('sku-header-extra')]);
